...
for i = 1:100
    starter = (i-1)*5e5+1;
    ender = i*5e5;
    yeptemp =  audioread('1_01.wav',[starter,ender]);
    yhimym01 = [yhimym01; sum(yeptemp,2)];
end
%Find the end of the last laugh
lastsample = himym1end(length(himym1end))*48000;
yeptemp =  audioread('1_01.wav',[ender,ceil(lastsample)]);
yhimym01 = [yhimym01; sum(yeptemp,2)];
...
for i = 1:100
    starter = (i-1)*5e5+1;
    ender = i*5e5;
    yeptemp =  audioread('5_01.wav',[starter,ender]);
    yhimym05 = [yhimym05; sum(yeptemp,2)];
end
%Find the end of the last laugh
lastsample = himym5end(length(himym5end))*48000;
yeptemp =  audioread('5_01.wav',[ender,ceil(lastsample)]);
yhimym05 = [yhimym05; sum(yeptemp,2)];
...
for i = 1:100
    starter = (i-1)*5e5+1;
    ender = i*5e5;
    yeptemp =  audioread('9_01.wav',[starter,ender]);
